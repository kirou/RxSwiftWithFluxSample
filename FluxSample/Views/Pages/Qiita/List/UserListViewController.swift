...
class UserListViewController: UIViewController {
    ...
    private var index: QiitaUserListIndexProtocol!
    ...
    private func updateView(data: QiitaUserListState) {
        
        tableView.data = data.userList
